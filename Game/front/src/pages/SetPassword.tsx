...
const SetPassword = () => {
    ...
    return (
        ...
        <Link to="/">
            <div className="logo">
                <span className="Twin1">
                    TwinP
                </span>
                <svg className="racquet1" version="1.0" xmlns="http://www.w3.org/2000/svg" width="55.000000pt" height="57.000000pt" viewBox="0 0 1095.000000 616.000000"
